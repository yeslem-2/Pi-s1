...
$conn = getDBConnection();
$result = $conn->query("SELECT * FROM notifications ORDER BY created_at DESC LIMIT 200");
$notifications = [];
...
<main class="md:ml-64 pt-20 px-8 pb-12 min-h-screen bg-surface-container-low">
  <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
    <div>
      <h1 class="font-headline text-4xl font-bold text-on-surface tracking-tight">System Notifications</h1>
  ...
  <div class="flex gap-2 flex-wrap mb-6" id="notif-filter-bar">
    <button class="filter-btn-active px-4 py-2 bg-primary text-on-primary text-xs font-bold rounded-lg" onclick="filterNotifs('all',this)">All</button>
